...
\begin{resumo}
  ...
  Os avanços do acesso às tecnologias da informação criou um ambiente fértil para a pesquisa na área de ensino a distância. Porém, apesar da grande disponibilidade e flexibilidade, os cursos da modalidade EAD, no Brasil, ainda sofrem com o problema da evasão de estudantes, como vem sendo mostrado no Censo EAD.BR dos ultimos anos. Acompanhando o crescimento da EAD, se desenvolve também a área de Mineração de Dados Educacionais. Inspirado pela Teoria da Distância Transacional (TDT), este trabalho propõe a utilização da metodologia de descoberta de conhecimento em bancos de dados para construir e comparar modelos de classificação da situação final de um aluno de curso EAD entre duas classes, evadidos e não evadidos. Este trabalho aplica a metodologia proposta por Ramos et al (2016), adaptado ao contexto da EAD na UNIVASF, onde as variáveis utilizadas nos modelos preditivos são construídas com base nos construtos da TDT, comparando os resultados obtidos com um novo cenário educacional.
