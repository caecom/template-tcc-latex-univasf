...
\imagem{1.0}{construcao_de_classificacao}{\label{classificationConstruction}
...
uma tabela denominada matriz de confusão. A Tabela 3 apresenta uma matriz de
confusão para um problema de classificação binária. Baseado nas entradas da
matriz de confusão, o número de previsões corretas realizadas pelo modelo é
\((f_{11} + f_{00})\) e o número de previsões incorretas é \((f_{10} +
f_{01})\).
