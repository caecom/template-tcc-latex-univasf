...
\textit{Data Mining}, DM), pode ser interpretada como uma etapa de um processo mais amplo
denominado como Descoberta de Conhecimento em Bases de Dados (DCBD, ou do
inglês, \textit{Knowledge Discovery in Databases}, KDD). Em KDD também são identificadas
